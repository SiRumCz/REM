...
def project_graph_analysis(G: nx.Graph, pname: str, outfile: str, outfolder: str, keyword: str, filter_flag: bool):
    ...
    # print graph shape
    print()
    print('software RUNTIME dependency graph shape:')
    print('nodes:', project_rt_sub_G.number_of_nodes())
    print('edges:', project_rt_sub_G.number_of_edges())
    print('software DEVELOPMENT dependency graph shape:')
    ...
    if (len(rt_sub_g_deprecated_list) == 0 and len(dev_sub_g_deprecated_list) == 0):
        print('Congratulations! There is no deprecated package in your application project.')
